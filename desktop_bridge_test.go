...
- button "Search" [ref=E3]`
	elements := browserKeyElements(snapshot, 10)
	if len(elements) != 3 {
...
func TestDetectBrowserChallengeIgnoresNormalPage(t *testing.T) {
	if challenge := detectBrowserChallenge(map[string]any{
...
func TestBrowserSessionArgsUseExecutableOverride(t *testing.T) {
	...
	args := browserSessionArgs("athena-00000000000000000000000000000000")
...
func TestBrowserSessionArgsSupportProfileAuthMode(t *testing.T) {
	...
	args := newBrowserController(home).sessionArgs("athena-00000000000000000000000000000000")
...
func TestBrowserSessionArgsSupportAutoConnectAuthMode(t *testing.T) {
	...
	args := newBrowserController(t.TempDir()).sessionArgs("athena-00000000000000000000000000000000")
...
func TestExecutableFileExistsRejectsMissingPath(t *testing.T) {
	if executableFileExists(filepath.Join(t.TempDir(), "missing-chrome")) {

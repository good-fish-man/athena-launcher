...
Launcher and service releases may use different versions. For example, Launcher `v0.1.3` can install services `v0.1.2`:
...
4. Push the Launcher release tag. Run **Release** with `tag=v0.1.3` and `service_tag=v0.1.2`; it collects those service assets, packages PostgreSQL, calculates hashes, and publishes `release-manifest.json` to the Launcher release.
